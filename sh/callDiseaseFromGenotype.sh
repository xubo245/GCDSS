...
out='/xubo/project/alignment/CloudBWA/g38/time/cloudBWAnewg38L50c'$num'Nhs20Paired12time10num16k1.callDiseaseFromGenotypeI'$i'.adam'
...
sh testCallDiseaseFromGenotype.sh $fq $vcfDatabase $out
done
done
