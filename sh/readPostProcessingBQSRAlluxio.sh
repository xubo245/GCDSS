...
out='alluxio://Master:19998/xubo/project/alignment/CloudBWA/g38/time/cloudBWAnewg38L50c'$num'Nhs20Paired12time10num16k1alluxio.BQSRI'$i'.adam'
vcf='/xubo/callVariant/vcf/vcfSelectAddSequenceDictionaryWithChr.adam'

~/cloud/alluxio-1.3.0/bin/alluxio fs rm -R $out
sh testReadPostProcessing.sh "BQSR" $fq $out $vcf
~/cloud/alluxio-1.3.0/bin/alluxio fs rm -R $out
done
done
